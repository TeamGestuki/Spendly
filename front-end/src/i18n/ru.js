...
scan: {
  ...
  heroTitle: 'Загрузите чек или подтверждение оплаты',
  heroText: 'Spendly проанализирует изображение и автоматически заполнит данные расхода, чтобы вы могли проверить их перед сохранением.',
  camera: 'Камера',
  cameraText: 'Сделайте чёткую фотографию чека.',
  gallery: 'Галерея',
  galleryText: 'Выберите изображение на устройстве.',
  change: 'Изменить изображение',
  remove: 'Удалить',
  analyze: 'Проанализировать чек',
  analyzing: 'Анализ чека...',
  reviewTitle: 'Проверьте распознанные данные',
  reviewText: 'Перед созданием расхода можно исправить любые данные.',
  saveExpense: 'Сохранить расход',
  saving: 'Сохранение расхода...',
  startAgain: 'Сканировать другой чек',
  fields: {
    amount: 'Сумма',
    description: 'Описание',
    category: 'Категория',
  ...
  permissions: {
    ...
    camera: 'Для съёмки нужен доступ к камере.',
    gallery: 'Для выбора изображения нужен доступ к галерее.',
  },
  validation: {
    amount: 'Введите корректную сумму больше нуля.',
    description: 'Введите описание.',
    date: 'Дата должна быть в формате YYYY-MM-DD.',
  },
  errors: {
    title: 'Не удалось обработать',
    analyze: 'Не удалось проанализировать чек.',
    save: 'Не удалось сохранить расход.',
  },
  success: {
    title: 'Расход сохранён',
    text: 'Расход успешно создан на основе чека.',
  },
},

biometricUnlock: {
  title: 'Разблокируйте Spendly',
  subtitle:
    'Используйте Face ID, Touch ID или аутентификацию устройства, чтобы продолжить.',
  prompt: 'Разблокировать Spendly',
  verifying: 'Проверка...',
  retry: 'Повторить',
  failed:
    'Не удалось подтвердить вашу личность. Попробуйте еще раз.',
  unavailable:
    'Биометрическая аутентификация недоступна или не настроена.',
},

editTransaction: {
  expenseTitle: 'Изменить расход',
  incomeTitle: 'Изменить доход',
  heroTitle: 'Обновите операцию',
  heroText: 'Измените необходимые данные и сохраните результат.',
  amount: 'Сумма',
  paymentMethod: 'Способ оплаты',
  date: 'Дата',
  currency: 'Валюта',
  ...
  successText: 'Транзакция успешно обновлена.',
  missing: 'Не удалось найти транзакцию для редактирования.',
  errors: {
    amount: 'Введите корректную сумму больше нуля.',
    description: 'Введите описание.',
    save: 'Не удалось обновить транзакцию.',
  },
},

passwordRecovery: { common:{errorTitle:'Не удалось продолжить'}, forgot:{title:'Восстановление пароля',heading:'Забыли пароль?',subtitle:'Введите электронную почту аккаунта, чтобы получить код.',emailLabel:'Электронная почта',emailPlaceholder:'name@email.com',send:'Отправить код',sending:'Отправка...',securityNote:'В целях безопасности ответ всегда одинаков.'}, verify:{title:'Проверка кода',heading:'Введите код',subtitle:'Введите шестизначный код из письма.',confirm:'Проверить код',verifying:'Проверка...',noCode:'Не получили код?',resend:'Отправить снова',resending:'Отправка...',resendIn:'Повторить через {seconds}с',expiration:'Код действует 10 минут и допускает 5 попыток.',resentTitle:'Код отправлен снова',resentText:'Новый код восстановления отправлен.'}, reset:{title:'Новый пароль',heading:'Создайте новый пароль',subtitle:'Выберите безопасный пароль, который ранее не использовался.',passwordLabel:'Новый пароль',passwordPlaceholder:'Не менее 8 символов',confirmLabel:'Подтвердите пароль',confirmPlaceholder:'Повторите пароль',requirements:'Используйте не менее 8 символов, буквы, цифры и знаки.',save:'Обновить пароль',saving:'Обновление...',successTitle:'Пароль обновлён',successText:'Пароль обновлён. Все предыдущие сеансы завершены.',goToLogin:'Перейти ко входу'}, errors:{emailRequired:'Введите электронную почту.',emailInvalid:'Введите корректный адрес.',sendCode:'Не удалось отправить код.',codeIncomplete:'Введите все 6 цифр.',verifyCode:'Не удалось проверить код.',resend:'Не удалось отправить код повторно.',invalidRequest:'Запрос недействителен.',passwordLength:'Пароль должен содержать 8 символов.',passwordMismatch:'Пароли не совпадают.',reset:'Не удалось обновить пароль.'}},
